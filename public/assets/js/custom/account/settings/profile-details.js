        ...
        init: function () {
            e = document.getElementById("kt_account_profile_details_form"), e.querySelector("#kt_account_profile_details_submit"), t = FormValidation.formValidation(e, {
                fields: {
                    ...
                    username: {validators: {notEmpty: {message: "Pilih username dahulu"}}},
                    password: {validators: {notEmpty: {message: "Password tiak boleh kosong"}}},
            ...
            })), $(e.querySelector('[name="username"]')).on("change", (function () {
                t.revalidateField("username")
